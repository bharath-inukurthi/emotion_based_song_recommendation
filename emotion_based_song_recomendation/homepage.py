...
sp_oauth = SpotifyOAuth(client_id=SPOTIFY_CLIENT_ID,client_secret=SPOTIFY_CLIENT_SECRET,redirect_uri=redirect_url, scope=SCOPE)
...
if not token_info:
    ...
    st.write(f"Click [here]({auth_url}) to authenticate with Spotify.")
else:
